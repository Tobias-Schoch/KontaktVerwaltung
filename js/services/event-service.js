/**
 * Event Service - Business Logic für Events
 */
...
class EventService {
    ...
    create(data) {
        ...
        appState.addEvent(event.toJSON());
        return event;
    }
    ...
    update(eventId, updates) {
        ...
        appState.updateEvent(eventId, updates);
        return updated;
    }
     ...
     */
    removeContact(eventId, contactId) {
        const event = this.get(eventId);
        if (!event) {
            throw new Error('Event nicht gefunden');
        }
